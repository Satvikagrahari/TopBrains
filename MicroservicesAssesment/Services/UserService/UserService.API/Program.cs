...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("StoreManagerOrAdmin", policy => policy.RequireRole("Admin", "StoreManager"));
    options.AddPolicy("CustomerOrAbove", policy => policy.RequireRole("Admin", "StoreManager", "Customer"));
});
...
using (var scope = app.Services.CreateScope())
{
    ...
    var roles = new[] { "Admin", "StoreManager", "Customer" };
